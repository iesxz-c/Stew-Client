...
import ScoreGraph from '../Task/ScoreGraph';
import { getTasks } from '../Task/api';
import ScoreCircles from '../Task/ScoreCircles';
  ...
  useEffect(() => {
    const fetchScores = async () => {
        ...
        if (storedToken) {
            ...
            try {
                const response = await getTasks(storedToken);
                const fetchedScores = response.data.map(task => task.score);
